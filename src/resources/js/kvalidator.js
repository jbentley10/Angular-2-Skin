...
{
	if(typeof(window._kdialog) == 'undefined'){window.addEventListener('resize',function(){try{window._kdialog.setOffsets();}catch(e){}});}
...
{
	try{var content = this.node.getElementsByClassName('kdialogContent')[0];}catch(e){console.log('nf');return false;}
